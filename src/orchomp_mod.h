...
public:
   ...
   mod(OpenRAVE::EnvironmentBasePtr penv) : OpenRAVE::ModuleBase(penv)
   {
      ...
      RegisterCommand("viewspheres",orwrap(boost::bind(&mod::viewspheres,this,_1,_2,_3)),"view spheres");
      RegisterCommand("computedistancefield",orwrap(boost::bind(&mod::computedistancefield,this,_1,_2,_3)),"compute distance field");
      RegisterCommand("addfield_fromobsarray",orwrap(boost::bind(&mod::addfield_fromobsarray,this,_1,_2,_3)),"compute distance field");
      RegisterCommand("create",orwrap(boost::bind(&mod::create,this,_1,_2,_3)),"create a chomp run");
      RegisterCommand("iterate",orwrap(boost::bind(&mod::iterate,this,_1,_2,_3)),"create a chomp run");
      RegisterCommand("gettraj",orwrap(boost::bind(&mod::gettraj,this,_1,_2,_3)),"create a chomp run");
      RegisterCommand("destroy",orwrap(boost::bind(&mod::destroy,this,_1,_2,_3)),"create a chomp run");
